...
#app.config['MYSQL_DATABASE_HOST'] = 'mehmet-phonebook-rds.cysse1ckidm4.us-east-1.rds.amazonaws.com'
...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', persons=persons_app, keyword=keyword, show_result=True, developer_name='Mehmet')
    else:
